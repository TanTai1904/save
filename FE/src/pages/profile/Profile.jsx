        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass-panel p-5 rounded-2xl border border-slate-200 dark:border-slate-800 text-center space-y-4">
            ...
            <div>
              ...
              <span className="inline-block text-[10px] font-mono text-slate-500 dark:text-slate-400 mt-1.5 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded select-all">
                ID: {user?.id}
              </span>
            </div>
            ...
            <div className="space-y-2.5">
              {[
                ...
                return (
                  <div 
                    key={badge.id} 
                    className={`flex items-center space-x-3 p-2 rounded-xl border transition-all ${badge.active ? 'bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-800' : 'bg-slate-50/50 dark:bg-slate-950/20 border-slate-200 dark:border-slate-900 opacity-50'}`}
                  >
